...
from ..coefficient import cal_cond_assoc
...
class TransferEntropy(object):
    ...
    def _cal_te(self, X, Y, sub_sample_size = None, rounds = None):
        ...
        # 时间轴平移
        _Xk = _Xk[self.h * self.tau_y:, :]
        _Yk = _Yk[: -self.h * self.tau_y, :]
        _Yh = _Yh[self.h * self.tau_y:, :]
        ...
        for _ in range(rounds):
            ...
            _xk, _yk, _yh = _Xk[_idxs, :], _Yk[_idxs, :], _Yh[_idxs, :]
            
            _te = cal_cond_assoc(_xk, _yh, _yk, "CMI-GIEF", "c", "c", "c")
    ...
    def cal_bg_te(self, sub_sample_size = None, rounds = None):
        ...
        for _ in range(rounds):
            ...
            _te_bg, _, _ = self._cal_te(X_shuff, self.Y, sub_sample_size, rounds=1)
